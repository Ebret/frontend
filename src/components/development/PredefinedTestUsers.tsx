...
const PredefinedTestUsers: React.FC = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <div className="bg-blue-600 text-white px-4 py-3">
        <h2 className="text-lg font-semibold">Predefined Test Users</h2>
      ...
      <div className="bg-gray-50 px-4 py-3 text-sm text-gray-500">
        <p>To create these test users in your database, run: <code className="bg-gray-200 px-1 py-0.5 rounded">npm run seed:test-users</code> in the backend directory.</p>
      </div>
    </div>
  );
};

export default PredefinedTestUsers;
